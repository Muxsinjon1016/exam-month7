...
export const EditPoductForm = ({ editedProductSubmit, categoryData }) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  return (
    <>
      <div className="bg-white fixed top-0 z-10 left-[8%] right-0 py-4 px-12 flex items-center justify-between">
        <div>
          <h2 className="text-xl font-extrabold mb-1">Edit Product</h2>
          ...
          >
            <div className="mb-[30px] relative">
              ...
              {errors.title && (
                <p className="text-red-600 font-medium text-lg">
                  ...
                  <MdErrorOutline className="absolute top-12 right-7 w-7 h-auto" />
                </p>
              )}
            </div>
            ...
            <div className="w-full fixed bottom-0 left-[8%] right-0 mx-auto bg-white py-[20px]">
              <div className="flex justify-center items-center gap-2">
                <Button children={"Save"} type={"submit"} variant={"add"} />
                <Button children={"Reset"} type={"reset"} variant={"logOut"} />
              </div>
            </div>
          </form>
        </div>
